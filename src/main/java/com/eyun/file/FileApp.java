package com.eyun.file;

import com.eyun.file.client.OAuth2InterceptedFeignConfiguration;
import com.eyun.file.config.ApplicationProperties;
import com.eyun.file.config.DefaultProfileUtil;
...
public class FileApp {
    ...
    public FileApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FileApp.class);
